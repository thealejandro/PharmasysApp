            ...
            <div class="flex flex-col md:flex-row gap-4 md:gap-5 w-full">
                ...
                <div class="flex-1 flex flex-col gap-4">
                    <div class="card bg-base-100 shadow-lg">
                        <div class="card-body">
                            <h2 class="card-title">{{ __("Data of user") }}</h2>
                            <div class="form-control gap-2">
                                ...
                                <label class="input-group">
                                    ...
                                    <input type="text" placeholder="First Name (required)" class="input input-bordered" />
                                </label>
                                <label class="input-group">
                                    <span>{{ __("Last Name") }}</span>
                                    <input type="text" placeholder="Last name (optional)" class="input input-bordered" />
                                </label>
                                <label class="input-group">
                                ...
                                <label class="input-group">
                                    <span>{{ __("Privileges") }}</span>
                                    <input type="text" placeholder="role" class="input input-bordered" />
                                </label>
                            </div>
                        </div>
                    </div>
